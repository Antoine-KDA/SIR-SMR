...
The goal of SIR-SMR is to help user to estimate Standardized Incidence Ratio (SIR) or Standardized Mortality Ratio (SMR) from cohort and population data using R.
